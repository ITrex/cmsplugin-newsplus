...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LatestNewsPlugin.default_img'
        db.add_column(u'cmsplugin_newsplus_latestnewsplugin', 'default_img',
                      self.gf('django.db.models.fields.files.ImageField')(default='', max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LatestNewsPlugin.default_img'
        db.delete_column(u'cmsplugin_newsplus_latestnewsplugin', 'default_img')
    ...
    models = {
        ...
        u'cmsplugin_newsplus.news': {
            ...
            'pub_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 10, 7, 0, 0)'}),
