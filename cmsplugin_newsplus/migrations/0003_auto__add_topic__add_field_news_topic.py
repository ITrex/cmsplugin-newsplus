...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'cmsplugin_newsplus_topic')

        # Deleting field 'News.topic'
        db.delete_column(u'cmsplugin_newsplus_news', 'topic_id')
    ...
    models = {
        ...
        u'cmsplugin_newsplus.news': {
            ...
            'pub_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 10, 10, 0, 0)'}),
